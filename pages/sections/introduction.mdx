...
```yaml:geneva-eval
description: Showing how to call a function
output:
  fn:add: [40, 2]
```
...
But is it changing? AWS has created [CDK](https://aws.amazon.com/cdk/) to let people write code in programming languages like Python rather than write YAML.
